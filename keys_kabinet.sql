...
CREATE TABLE `kabinet` (
  ...
  `kabinetcol` varchar(7) DEFAULT NULL,
  `sos` int DEFAULT NULL,
...
INSERT INTO `kabinet` VALUES (1,'1',1),(2,'2',1),(3,'3',0),(4,'4',0),(5,'5',0),(6,'6',0);
...
-- Dump completed on 2023-01-25 21:59:48
